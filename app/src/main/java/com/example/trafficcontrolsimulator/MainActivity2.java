    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reffread.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                //Acrescentar condições para os diferentes estados
                ...
                else if (street1.equals("Yellow") && street2.equals("Red") && pedestrian1.equals("Red")){
                ...
                else if (street1.equals("Red") && street2.equals("Yellow") && pedestrian1.equals("Green")){
