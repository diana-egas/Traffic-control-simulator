...
foreach ($arduino_data as $key=>$value) {
    if (is_numeric($value)) $arduino_data[$key]= (int) $value; 
}
// --- $arduino_data_post = $_POST['name'];
// --- Set up your Firebase url structure here
$firebasePath = '/crossing';
/// --- Making calls
$fb = new fireBase($url, $token);
$response = $fb->update($firebasePath,$arduino_data);
echo $arduino_data;
echo $response;
...
// ?arduino_data[street1_cars]=7&arduino_data[street_1]=Green
